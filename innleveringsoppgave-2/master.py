...
def PoengFraValg (problem, valgmuligheter):
    ...
    #Utifra oppgavebeskrivelsen i del 1 trodde vi det var lov å ha flere enn 2 valgmuligheter, og har lagd programmet slik at den kan behandle situasjoner med både 2 og 3 svaralternativer.
